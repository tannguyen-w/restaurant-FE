...
const ManageDish = () => {
  ...
  const fetchFilters = useCallback(async () => {
    try {
      ...
      const [categoriesData, restaurantsData] = await Promise.all([categoriesPromise, restaurantsPromise]);
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: "isCombo",
      key: "isCombo",
      render: (isCombo) => (isCombo ? <Tag color="purple">Combo</Tag> : <Tag color="blue">Đơn lẻ</Tag>),
    },
    {
      title: "Danh mục",
        ...
        return (
          <Space>
            <Tooltip title="Xem chi tiết">
              <Button icon={<EyeOutlined />} size="small" onClick={() => handleViewDish(record)} />
            </Tooltip>

            {(isAdmin || isOwner) && (
              <>
                <Tooltip title="Chỉnh sửa">
                  <Button icon={<EditOutlined />} size="small" onClick={() => handleEditDish(record)} />
                </Tooltip>

                <Tooltip title="Xóa">
                  <Button danger icon={<DeleteOutlined />} size="small" onClick={() => handleDeleteClick(record)} />
                </Tooltip>
              </>
            )}
          </Space>
  ...
  return (
    <>
      ...
      {/* Modal xem chi tiết */}
      <ViewDishModal visible={viewModalVisible} dish={selectedDish} onCancel={() => setViewModalVisible(false)} />
