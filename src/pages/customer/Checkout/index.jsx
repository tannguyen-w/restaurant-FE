...
const Checkout = () => {
  ...
  useEffect(() => {
    const fetchTables = async () => {
      try {
        ...
        message.error({
          content: "Không thể tải danh sách bàn. Vui lòng thử lại sau.",
          style: { color: "#000" }
        });
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    customer: user?.id, // Thêm ID của người đăng nhập
      table: selectedTableId, // Sử dụng bàn đã chọn
  ...
  for (const item of cartItems) {
    try {
      ...
      console.log("Sending order detail data:", orderDetailData);
      const detailResponse = await createOrderDetail(orderDetailData);
      console.log("Detail created successfully:", detailResponse);
      successCount++;
    } catch (detailError) {
            ...
            <div className="row row-cols-2 g-3 row-cols-lg-1">
              <div className="col">
                <div className="checkout-bill">
                  <h4 className="checkout-bill__heading">
                  ...
                  <form onSubmit={handleSubmit} className="form">
                    <div className="checkout-bill-form">
                      <div className="checkout-bill-form__group">
                        <label
                          htmlFor="fullName"
                          className="checkout-bill-form__title"
                        >
                          Họ và tên
                        </label>
                        <input
                      ...
                      <div className="checkout-bill-form__group">
                        ...
                        <Select
                          ...
                          className="checkout-bill-form__select"
                        >
