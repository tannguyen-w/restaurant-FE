...
const DishDetail = () => {
  ...
  const imageUrl = dish.images && dish.images.length > 0 
    ? `http://localhost:8081${dish.images[0]}`
    : {dishImageDefault};
        ...
        <div className="row row-cols-2 row-cols-md-1">
            ...
            <div className="col">
                <div className="product-detail__right">
                    ...
                    <span className="product-detail__price-product">{new Intl.NumberFormat("vi-VN", {
                    style: "currency",
                    currency: "VND"
                  }).format(dish.price || 0)}</span>
                    <p className="product-detail__desc-product">
                        {dish.description }
                    </p>
